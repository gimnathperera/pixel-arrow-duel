...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 overflow-hidden selection:bg-blue-500/30">
      {showGameCanvas ? (
        /* ── Full-bleed game view ── */
        <div
        ...
        >
          ...
          {/* Top HUD */}
          {gameState && (
            <div className="absolute inset-x-0 top-0 pointer-events-none z-10 p-3 sm:p-5">
          ...
          {/* Bottom-left: menu button + controls hint */}
          <div className="absolute bottom-4 left-4 z-10 flex flex-col items-start gap-2">
            <button
              type="button"
              onClick={goToMenu}
              className="glass-button cursor-pointer glass-panel px-5 py-2 rounded-full text-slate-300 hover:text-white text-xs font-bold uppercase tracking-[0.2em] flex flex-row items-center justify-center gap-2 leading-none"
            >
              <span
            ...
            {screen === "local" && (
              <div className="flex gap-3 text-[8px] font-semibold tracking-wider text-slate-500 uppercase pointer-events-none">
          ...
          {/* Match over overlay */}
          {gameState?.matchOver && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/60 backdrop-blur-md z-30 p-4">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 backdrop-blur-xl z-40 p-8">
              <div className="text-center space-y-6">
                ...
                <p className="text-slate-400 max-w-xs mx-auto">
                  The other duelist has vanished into the digital void. The
                  match is nullified.
                </p>
                <button
                  type="button"
